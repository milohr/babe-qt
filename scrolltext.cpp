...
ScrollText::ScrollText(QLabel *parent) : QLabel(parent)
{
    px = 0;
    py = 10;
    speed = 0;
...
void ScrollText::setSpeed(int s)
{
    speed = s;
}

int ScrollText::getSpeed()
{
    return speed;
}
